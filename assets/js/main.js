		...
		var settings = {
			...
			// Scroll wheel.
				scrollWheel: {
					...
					// Sets the scroll wheel factor. (Ideally) a value between 0 and oa183 (lower = slower scroll, higher = faster scroll).
						factor: 1
			...
			// Dragging.
				dragging: {
					...
					// Sets the momentum factor. Must be a value between 0 and oa183 (lower = less momentum, higher = more momentum, 0 = disable momentum scrolling).
						momentum: 0.875,
		...
		$(function() {
			...
			// Gallery.
				$('.gallery')
					...
					.prepend('<div class="modal" tabIndex="-oa183"><div class="inner"><img src="" /></div></div>')
						.find('img')
